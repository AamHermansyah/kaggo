...
export interface ApiRequest {
  ...
  /**
   * Per-request timeout. Defaults to `API_TIMEOUT_MS`. Kept deliberately short
   * so a hanging upstream route degrades into a retryable error in the UI
   * instead of blocking the whole render.
   */
  timeoutMs?: number
  /**
